...
// Model for Manufacturer entity
    models.Manufacturer = Backbone.Model.extend({
        urlRoot: "http://localhost:8080/proveedorRestUdea/webresources/manufacturer/",
        defaults: {
            zip: "",
            city: "",
            phone: "",
        ...
        sync: function (method, model, options) {
            ...
            if (method === 'create') {
                options.url = 'http://localhost:8080/proveedorRestUdea/webresources/manufacturer/';
            }
    ...
    models.ManufacturerCollection = Backbone.Collection.extend({
        ...
        url: "http://localhost:8080/proveedorRestUdea/webresources/manufacturer/",
        sync: function (method, model, options) {
            options || (options = {});
            var errorHandler = {
                error: function (jqXHR, textStatus, errorThrown) {
